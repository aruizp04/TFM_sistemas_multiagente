...
> Note: If you are using Open-RMF binaries from ROS 2 Humble or an older distribution, switch to the [humble](https://github.com/open-rmf/turtlebot4_adapter/tree/humble) branch.
...
ros2 run turtlebot4_adapter fleet_adapter -c CONFIG_FILE -n NAV_GRAPH

#Usage with the websocket uri
ros2 run turtlebot4_adapter fleet_adapter -c CONFIG_FILE -n NAV_GRAPH -s SERVER_URI

#e.g.
ros2 run turtlebot4_adapter fleet_adapter -c CONFIG_FILE -n NAV_GRAPH -s ws://localhost:7878
```
